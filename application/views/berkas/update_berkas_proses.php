            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo site_url("Berkas/update_berkas_proses"); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
